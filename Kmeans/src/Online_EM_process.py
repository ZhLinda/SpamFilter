...
#def Update_model_with_labeled_data(filename):
...
if __name__ == "__main__":
    ...
    #test_corpus = [line.decode("utf-8") for line in open(f_new_data, "r").readlines()]
    test_corpus = open(f_new_data, "r").readlines()
    for count in range(len(test_corpus)):
        Classify_new_data(test_corpus[count], Vector_type, update_model=0, update_dictionary=0)
