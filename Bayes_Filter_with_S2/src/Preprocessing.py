...
def get_data_segmented(stopWords,filename):
    fp = open(filename,'r')
    lines = fp.readlines()
    for line in lines:
        ...
        get_extra_features(uString,cnt_filtered,total_ord,ave_ord) #计算除词向量外的其他特征
...
def get_extra_features(ustring,cnt_filtered,total_ord,ave_ord):
